class CreateArchivedRawValues < ActiveRecord::Migration[7.2]
  def change
    create_table :archived_raw_values do |t|
    ...
    add_index :archived_raw_values, [:measurement_point_id, :sample_time]
    add_index :archived_raw_values, :sample_time
  end
end
