...
ActiveRecord::Base.transaction do
  ...
  SCHEDULE_SLOT_REGISTERS = [
    ...
    { name: 'One-time Year',      group_role: 'onetime_year',    data_type: 'uint16',  value_format: 'numeric',          addr_count: 1, default_value: 0, min_value: 2020, max_value: 9999, validation_rules: { 'required_when' => { 'group_role' => 'schedule_type', 'equals' => '1' } }, visibility_conditions: { 'schedule_type' => ['1'] } }
  ].freeze
