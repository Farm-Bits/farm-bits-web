...
ActiveRecord::Base.transaction do
  ...
  OM_MANUAL_STATUS_REGISTERS = [
    { name: 'Command',  group_role: 'command',  data_type: 'uint16', value_format: 'enum',             addr_count: 1, is_status: true, default_value: 0, enum_values: { '0' => 'Idle', '1' => 'Turn On', '2' => 'Turn On (Timed)', '3' => 'Turn Off', '4' => 'Auto' }, description: 'Manual command. PLC resets to None after executing' }
  ].freeze
